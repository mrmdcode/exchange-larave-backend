                ...
                <ul>
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="/panel/admin/confirm_auth">تایید احراز هویت</a></li>
                            <li><a href="/panel/admin/view_users">اطلاعات کاربران</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="/panel/admin/buy">خرید از مشتری</a></li>
                            <li><a href="/panel/admin/sell">فروش به مشتری</a></li>
                            <li><a href="/panel/admin/transaction">سابقه ها</a></li>

                        </ul>
                    </li>
                    <li>
                        <a href="/panel/admin" class="waves-effect">
                            <i class="dripicons-home"></i>
                            <span> تعیین نرخ  <span class="badge badge-success badge-pill float-right"></span></span>
                        </a>
                    </li>
                    </ul>
            </div>
